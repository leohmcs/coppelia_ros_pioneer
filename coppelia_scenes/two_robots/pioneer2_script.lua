function sysCall_init()
    ...
    motorLeft=sim.getObjectHandle("Pioneer_p3dx_leftMotor#0")
    motorRight=sim.getObjectHandle("Pioneer_p3dx_rightMotor#0")
    ...
    if simROS then
        ...
        local leftMotorTopicName='pioneer2/pioneer/left_wheel_velocity'
        local rightMotorTopicName='pioneer2/pioneer/right_wheel_velocity'
        ...
        publisher_joints_right = simROS.advertise('/pioneer2/pioneer/right_wheel_joint_state','sensor_msgs/JointState')
        publisher_joints_left = simROS.advertise('/pioneer2/pioneer/left_wheel_joint_state','sensor_msgs/JointState')
        ...
        -- Prepare GT pose
        publisher_gt_relative_pose = simROS.advertise('/pioneer2/gt_relative_pose', 'geometry_msgs/Pose')
        publisher_gt_pose = simROS.advertise('/pioneer2/gt_pose', 'geometry_msgs/Pose')
        publisher_initial_pose = simROS.advertise('/pioneer2/pioneer/initial_pose', 'geometry_msgs/Pose', 1, true)
        ...
        initial_pose_msg = {}
        initial_pose_msg['position'] = {x = initial_pose[1], y = initial_pose[2], z = initial_pose[3]}
        initial_pose_msg['orientation']= {x = o[1], y = o[2], z = o[3], w = o[4]}
        simROS.publish(publisher_initial_pose, initial_pose_msg)
