function sysCall_init()
    ...
    if simROS then
        ...
        local leftMotorTopicName='pioneer1/pioneer/left_wheel_velocity'
        local rightMotorTopicName='pioneer1/pioneer/right_wheel_velocity'
        ...
        publisher_joints_right = simROS.advertise('/pioneer1/pioneer/right_wheel_joint_state','sensor_msgs/JointState')
        publisher_joints_left = simROS.advertise('/pioneer1/pioneer/left_wheel_joint_state','sensor_msgs/JointState')
        ...
        -- Prepare GT pose
        publisher_gt_relative_pose = simROS.advertise('/pioneer1/gt_relative_pose', 'geometry_msgs/Pose')
        publisher_gt_pose = simROS.advertise('/pioneer1/gt_pose', 'geometry_msgs/Pose')
        publisher_initial_pose = simROS.advertise('/pioneer1/pioneer/initial_pose', 'geometry_msgs/Pose', 1, true)
